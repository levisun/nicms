...
(1, 0, 1, 'admin', '后台', 1, 0, '后台模块'),
    ...
    (4, 1, 2, 'category', '栏目', 1, 0, '栏目控制器'),
        (41, 4, 3, 'category', '管理栏目', 1, 0, '管理栏目方法'),
            ...
            (414, 41, 4, 'sort', '管理栏目排序', 1, 0, '管理栏目排序操作'),
            (415, 41, 4, 'upload', '管理栏目上传', 1, 0, '管理栏目上传操作'),
    ...
    (5, 1, 2, 'content', '内容', 1, 0, '内容控制器'),
        (51, 5, 3, 'article', '管理内容', 1, 0, '管理内容方法'),
            (511, 51, 4, 'added', '管理内容添加', 1, 0, '管理内容添加操作'),
            (512, 51, 4, 'remove', '管理内容删除', 1, 0, '管理内容删除操作'),
            (513, 51, 4, 'editor', '管理内容编辑', 1, 0, '管理内容编辑操作'),
            (514, 51, 4, 'sort', '管理内容排序', 1, 0, '管理内容排序操作'),
            (515, 51, 4, 'upload', '管理内容上传', 1, 0, '管理内容上传操作'),
        (52, 5, 3, 'link', '管理友情链接', 1, 0, '管理友情链接方法'),
            (521, 52, 4, 'added', '管理友情链接添加', 1, 0, '管理友情链接添加操作'),
            (522, 52, 4, 'remove', '管理友情链接删除', 1, 0, '管理友情链接删除操作'),
            (523, 52, 4, 'editor', '管理友情链接编辑', 1, 0, '管理友情链接编辑操作'),
            (524, 52, 4, 'sort', '管理友情链接排序', 1, 0, '管理友情链接排序操作'),
            (525, 52, 4, 'upload', '管理友情链接上传', 1, 0, '管理友情链接上传操作'),
        (53, 5, 3, 'feedback', '管理反馈', 1, 0, '管理反馈方法'),
            (531, 53, 4, 'added', '管理反馈添加', 1, 0, '管理反馈添加操作'),
            (532, 53, 4, 'remove', '管理反馈删除', 1, 0, '管理反馈删除操作'),
            (533, 53, 4, 'editor', '管理反馈编辑', 1, 0, '管理反馈编辑操作'),
        (54, 5, 3, 'message', '管理留言', 1, 0, '管理留言方法'),
            (541, 54, 4, 'added', '管理留言添加', 1, 0, '管理留言添加操作'),
            (542, 54, 4, 'remove', '管理留言删除', 1, 0, '管理留言删除操作'),
            (543, 54, 4, 'editor', '管理留言编辑', 1, 0, '管理留言编辑操作'),

        (55, 5, 3, 'banner', '管理幻灯片', 1, 0, '管理幻灯片方法'),
            (551, 55, 4, 'added', '管理幻灯片添加', 1, 0, '管理幻灯片添加操作'),
            (552, 55, 4, 'remove', '管理幻灯片删除', 1, 0, '管理幻灯片删除操作'),
            (553, 55, 4, 'editor', '管理幻灯片编辑', 1, 0, '管理幻灯片编辑操作'),
            (554, 55, 4, 'sort', '管理幻灯片排序', 1, 0, '管理幻灯片排序操作'),
            (555, 55, 4, 'upload', '管理幻灯片上传', 1, 0, '管理幻灯片上传操作'),
        (56, 5, 3, 'ads', '管理广告', 1, 0, '管理广告方法'),
            (561, 56, 4, 'added', '管理广告添加', 1, 0, '管理广告添加操作'),
            (562, 56, 4, 'remove', '管理广告删除', 1, 0, '管理广告删除操作'),
            (563, 56, 4, 'editor', '管理广告编辑', 1, 0, '管理广告编辑操作'),
            (564, 56, 4, 'upload', '管理广告上传', 1, 0, '管理广告上传操作'),
        (57, 5, 3, 'discuss', '管理评论', 1, 0, '管理评论方法'),
            (571, 57, 4, 'remove', '管理评论删除', 1, 0, '管理评论删除操作'),
            (572, 57, 4, 'editor', '管理评论编辑', 1, 0, '管理评论编辑操作'),
        (58, 5, 3, 'recycle', '内容回收站', 1, 0, '内容回收站方法'),
            (581, 58, 4, 'remove', '内容回收站删除', 1, 0, '内容回收站删除操作'),
            (582, 58, 4, 'recover', '内容回收站恢复', 1, 0, '内容回收站恢复操作'),
        (59, 5, 3, 'cache', '更新缓存或静态', 1, 0, '更新缓存方法'),
            (591, 59, 4, 'compile', '编译缓存文件', 1, 0, '更新编译缓存文件操作'),
            (592, 59, 4, 'request', '请求缓存的文件', 1, 0, '更新请求缓存的文件操作'),
            (593, 59, 4, 'api', 'API缓存的文件', 1, 0, '更新API缓存的文件操作'),
            (594, 59, 4, 'total', '统计缓存文件', 1, 0, '统计缓存文件操作'),
    ...
    (8, 1, 2, 'book', '书库', 1, 0, '书库控制器'),
        ...
        (82, 8, 3, 'article', '管理章节', 1, 0, '管理章节方法'),
            ...
            (824, 82, 4, 'sort', '管理章节排序', 1, 0, '管理章节排序操作'),
        ...
        (85, 5, 3, 'recycle', '内容回收站', 1, 0, '内容回收站方法'),
            (851, 85, 4, 'remove', '内容回收站删除', 1, 0, '内容回收站删除操作'),
            (852, 85, 4, 'recover', '内容回收站恢复', 1, 0, '内容回收站恢复操作'),
    ...
    (9, 1, 2, 'extend', '扩展', 1, 0, '扩展控制器'),
        ...
        (95, 9, 3, 'addon', '插件管理', 1, 0, '插件管理方法'),
            (951, 95, 4, 'added', '管理插件添加', 1, 0, '管理插件添加操作'),
            (952, 95, 4, 'remove', '管理插件删除', 1, 0, '管理插件删除操作'),
            (953, 95, 4, 'editor', '管理插件编辑', 1, 0, '管理插件编辑操作');
 */
