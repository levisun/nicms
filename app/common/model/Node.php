...
(1, 0, 1, 'admin', '后台', 1, 0, '后台模块'),
    ...
    (5, 1, 2, 'content', '内容', 1, 0, '内容控制器'),
        ...
        (52, 5, 3, 'link', '管理友情链接', 1, 0, '管理友情链接方法'),
            ...
            (524, 52, 4, 'upload', '管理友情链接上传', 1, 0, '管理友情链接上传操作'),
        ...
        (55, 5, 3, 'banner', '管理幻灯片', 1, 0, '管理幻灯片方法'),
            ...
            (554, 55, 4, 'upload', '管理幻灯片上传', 1, 0, '管理幻灯片上传操作'),
        ...
        (57, 5, 3, 'comment', '管理评论', 1, 0, '管理评论方法'),
        ...
        (59, 5, 3, 'cache', '更新缓存或静态', 1, 0, '更新缓存或静态方法'),
            (591, 59, 4, 'reCompile', '编译缓存文件', 1, 0, '编译缓存文件操作'),
            (592, 59, 4, 'reCache', '数据缓存的文件', 1, 0, '数据缓存的文件操作'),
            (593, 59, 4, 'reRequest', '请求缓存的文件', 1, 0, '请求缓存的文件操作'),
