...
class Tag
{
    ...
    public function head(array $_attr, string &$_content)
    {
        ...
        return '<!DOCTYPE html>' .
            ...
            '<script src="__STATIC_HOST__static/<?php echo trim(base64_encode(app("http")->getName()), "=");?>.do?token=<?php echo trim(base64_encode(json_encode(app("request")->param())), "=");?>&version=' . $this->config['theme_config']['api_version'] . '"></script>' .
